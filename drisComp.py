...
def runComparison(legList, newList):
    ...
    for oldInfo in legList:
        ...
        for newInfo in newList:
            if ((str(oldInfo[0]) + " " + str(oldInfo[1])) == newInfo[0] and oldInfo[2] == newInfo[1] and oldInfo[3] ==
                    newInfo[2] and oldInfo[4] == newInfo[3] and oldInfo[5] == newInfo[4] and oldInfo[6] == newInfo[
                        5] and oldInfo[7] == newInfo[6] and oldInfo[-1] == newInfo[-1]):
                flag = True
                print((str(oldInfo)) + '\n')
                print(str(newInfo) + '\n\n')
